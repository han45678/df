        ...
        <main id="company_serve">
                ...
                <div id="banner_text">
                    <div class="text">
                        ...
                        <div class="text_content slick_an">
                            <div class="item" v-for="(item, index) in banner_text" :key="index" v-html="item.text" />
                        </div>
                        <div class="link">
                            <a href="https://www.youtube.com/@DaFon2001"><img loading="lazy"
                                    src="@/assets/images/icon/play_icon.svg" alt="icon" /></a>
                            <a href="https://www.facebook.com/TaiwanDafon/"><img loading="lazy"
                                    src="@/assets/images/icon/fb_icon.svg" alt="icon" /></a>
                        </div>
                    </div>
                </div>
                <div id="banner_pic">
                    <img v-for="(item, index) in banner_pic" :key="index" :src="require(`@/assets/images/company_serve/enterprise/${item.pic}`)
                        " alt="banner" />
                </div>
            </div>
            <div id="banner_title">
                ...
                <div class="wrapper">
                    ...
                    <div id="serve_item_content">
                        ...
                        <a class="item item2" href="javascript:void(0)">
                            ...
                            <div class="pic">
                                <img loading="lazy" src="@/assets/images/company_serve/enterprise/serve_item_pic02.jpg"
                                    alt="pic" />
                            </div>
                        </a>
                        <a class="item item3" href="javascript:void(0)">
                            ...
                            <div class="pic">
                                <img loading="lazy" src="@/assets/images/company_serve/enterprise/serve_item_pic03.jpg"
                                    alt="pic" />
                            </div>
                        </a>
                        ...
                        <a class="item item7" href="javascript:void(0)">
                            ...
                            <div class="pic">
                                <img loading="lazy" src="@/assets/images/company_serve/enterprise/serve_item_pic07.jpg"
                                    alt="pic" />
                            </div>
                        </a>
                    </div>
            ...
            <div id="advantage_item">
                ...
                <div id="advantage_content" class="lazy_img_wrapper">
                    <div class="item an fu">
                        <div class="no">01</div>
                        <div class="icon">
                            <div class="lazy_img_pic lazy_img"
            ...
            <div id="scope">
                <div class="wrapper">
                    ...
                    <div class="content">
                        <img loading="lazy" class="bg" src="@/assets/images/company_serve/enterprise/scope_bg.jpg"
                            alt="bg" />
                        <div class="text">
                            <div class="item">
                                <h5>3000+</h5>
            ...
            <div id="cooperate">
                ...
                <div class="content">
                        ...
                        <div class="group">
                            <div class="item">
                                <div class="item_content">
                                    <img loading="lazy" src="@/assets/images/company_serve/enterprise/cooperate_pic01.png"
                                        alt="pic" />
                                    <h5>電子科技產業</h5>
                                </div>
                            </div>
                            <div class="item">
                                <div class="item_content">
                                    <img loading="lazy" src="@/assets/images/company_serve/enterprise/cooperate_pic02.png"
                                        alt="pic" />
                                    <h5>服務產業</h5>
                                </div>
                            </div>
                            <div class="item">
                                <div class="item_content">
                                    <img loading="lazy" src="@/assets/images/company_serve/enterprise/cooperate_pic03.png"
                                        alt="pic" />
                                    <h5>食品製造業</h5>
                                </div>
                            </div>
                            <div class="item">
                                <div class="item_content">
                                    <img loading="lazy" src="@/assets/images/company_serve/enterprise/cooperate_pic04.png"
                                        alt="pic" />
                                    <h5>金融產業</h5>
                                </div>
                            </div>
                            <div class="item">
                                <div class="item_content">
                                    <img loading="lazy" src="@/assets/images/company_serve/enterprise/cooperate_pic05.png"
                                        alt="pic" />
                                    <h5>政府單位</h5>
                                </div>
                            </div>
                            <div class="item">
                                <div class="item_content">
                                    <img loading="lazy" src="@/assets/images/company_serve/enterprise/cooperate_pic06.png"
                                        alt="pic" />
                                    <h5>運輸物流產業</h5>
                                </div>
                            </div>
                            <div class="item">
                                <div class="item_content">
                                    <img loading="lazy" src="@/assets/images/company_serve/enterprise/cooperate_pic07.png"
                                        alt="pic" />
                                    <h5>醫療產業</h5>
                                </div>
                            </div>
                    ...
                    <div id="cooperate_pic">
                        <div class="pic">
                            <img loading="lazy" src="@/assets/images/company_serve/enterprise/cooperate_pic.jpg"
                                alt="pic" />
                        </div>
                    </div>
                </div>
